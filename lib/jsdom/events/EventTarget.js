/* jshint strict: false */
// no use-strict (need this)

var EventException = require("./EventException");
var handles = require("../browser/global-handles");
...
EventTarget.prototype.addEventListener = function (type, callback, capture) {
  ...
  // implicit-this workaround
  var instance = this;
  if (instance.__jsdom === undefined) {
    instance = handles.getWindow(this);
  }

  var events = instance.__jsdom[propEvents];
